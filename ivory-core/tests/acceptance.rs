...
const FLAT_ROWS: &[Row] = &[
    ...
    (&[60, 63, 66], Some("Cdim"), "v013 parity"),
    (&[60, 64, 68], Some("Caug"), "v014 parity"),
    (&[64, 68, 72], Some("Eaug"), "v015 parity (aug re-root to bass)"),
    ...
    (&[71, 74, 77, 81], Some("Bm7b5"), "v043 K2 (never ø7)"),
    (&[55, 58, 61, 65], Some("Gm7b5"), "v044 K10"),
    (&[58, 61, 65, 67], Some("Bbm6"), "v045 K10 (half-dim inversion → m6)"),
    (&[53, 62, 68, 72], Some("Fm6"), "v046 K10 (Dm7b5, F bass)"),
    (&[68, 71, 74, 78], Some("Abm7b5"), "v047 K10"),
    (&[60, 63, 66, 69], Some("Cdim7"), "v048 parity"),
    (&[63, 66, 69, 72], Some("Ebdim7"), "v049 parity (dim7 re-root to bass)"),
    (&[60, 63, 66, 71], Some("CdimΔ7"), "v050 parity"),
    ...
    (&[66, 70, 74], Some("Gbaug"), "v061 D9-keep (no tritone, symmetric)"),
    ...
    (&[60, 62, 65, 68, 71], Some("Ddim7/C"), "v082 D5-keep (genuine E2 branch)"),
